...
export default function About() {
  return (
    <>
      <Head>
        <title>About - Bill Evans</title>
        <meta
          name="description"
          content="I'm Bill Evans. I'm a programmer, marketer and entrepeneur."
        />
      </Head>
      <Container className="mt-16 sm:mt-32">
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:pl-20">
            <ul role="list">
              <SocialLink href="https://github.com/thirteenpixels" icon={GitHubIcon} className="mt-4">
                Follow on GitHub
              </SocialLink>
              <SocialLink href="https://www.linkedin.com/in/thirteenpixels/" icon={LinkedInIcon} className="mt-4">
                Follow on LinkedIn
              </SocialLink>
              <SocialLink
                href="mailto:bill@thirteenpixels.com"
                icon={MailIcon}
                className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40"
              >
                bill@thirteenpixels.com
              </SocialLink>
            </ul>
          </div>
        </div>
