...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Bill Evans - Software Engineer, Email Marketing Expert and Entrepeneur
        </title>
        <meta
          name="description"
          content="Hello, my name is Bill Evans. I'm a software engineer, email marketing expert and entrepeneur."
        />
      </Head>
